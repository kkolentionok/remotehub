...
var k = class extends S {
  ...
  _rowEnd(e, r) {
    ...
    let t = "";
    if (!r) {
      e - this._firstRow >= this._terminal.rows && ((_a = this._buffer.getLine(this._cursorStyleRow)) == null ? void 0 : _a.getCell(this._cursorStyleCol, this._backgroundCell));
...
var D = class {
  ...
  _serializeBufferAsHTML(o, e) {
    ...
    let i = (_a = this._terminal) == null ? void 0 : _a.getSelectionPosition();
  ...
  serialize(o) {
    ...
    let e = (o == null ? void 0 : o.range) ? this._serializeBufferByRange(this._terminal, this._terminal.buffer.normal, o.range, true) : this._serializeBufferByScrollback(this._terminal, this._terminal.buffer.normal, o == null ? void 0 : o.scrollback);
    if (!(o == null ? void 0 : o.excludeAltBuffer) && this._terminal.buffer.active.type === "alternate") {
      let r = this._serializeBufferByScrollback(this._terminal, this._terminal.buffer.alternate, void 0);
      e += `\x1B[?1049h\x1B[H${r}`;
    }
    return (o == null ? void 0 : o.excludeModes) || (e += this._serializeModes(this._terminal)), e;
  }
  serializeAsHTML(o) {
    if (!this._terminal) throw new Error("Cannot use addon until it has been loaded");
...
var M = class extends S {
  ...
  _beforeSerialize(e, r, t) {
    ...
    (this._options.includeGlobalBackground ?? false) && (a = ((_a = this._terminal.options.theme) == null ? void 0 : _a.foreground) ?? "#ffffff", s = ((_b = this._terminal.options.theme) == null ? void 0 : _b.background) ?? "#000000");
    let i = [];
...
@xterm/addon-serialize/lib/addon-serialize.mjs:
   ...
   *)
*/
//# sourceMappingURL=@xterm_addon-serialize.js.map
