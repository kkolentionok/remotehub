            ...
            optional_data: ClientCoreOptionalData {
                ...
                early_capability_flags: {
                    let mut early_capability_flags = ClientEarlyCapabilityFlags::VALID_CONNECTION_TYPE
                        ...
                        // RemoteHub patch: advertise Graphics Pipeline (MS-RDPEGFX)
                        // support so the server opens the Microsoft::Windows::RDS::Graphics
                        // DVC and streams H.264/AVC instead of legacy bitmap/RemoteFX.
