...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::notes::notes_pair_create,
            api::notes::notes_pair_claim,
            api::notes::notes_pair_devices,
            api::notes::notes_pair_revoke,
            api::notes::notes_mode,
            api::notes::notes_unpair,
